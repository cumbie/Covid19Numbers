...
{
    public class CountryHistoricalPageViewModel : ViewModelBase
    {
        ICovidApi _covidApi;

        public CountryHistoricalPageViewModel(INavigationService navigationService, ICovidApi covidApi)
